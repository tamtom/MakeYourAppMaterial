...
public class ArticleDetailFragment extends Fragment implements
    ...
    private void bindViews() {
        ...
        if (mCursor != null) {
            ...
            GlideApp.with(getContext()).load(mCursor.getString(ArticleLoader.Query.PHOTO_URL))
        ...
        Palette.from(bitmap).generate(new Palette.PaletteAsyncListener() {
            ...
            public void onGenerated(@NonNull Palette palette) {
                ...
                if (mToolbarLayout != null) {
                    mToolbarLayout.setContentScrimColor(plattedColor);
                    mToolbarLayout.setStatusBarScrimColor(plattedColor);
                }
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                    Window window = getActivity().getWindow();
                    window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
                    window.setStatusBarColor(plattedColor);
                    window.setNavigationBarColor(plattedColor);
